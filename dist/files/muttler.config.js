...
function multerOptions(userFolder) {
    const multerOptions = {
        limits: {
        ...
        storage: (0, multer_1.diskStorage)({
            destination: (req, file, cb) => {
                console.log(exports.multerConfig.destination);
                const uploadPath = process.env.UPLOAD_LOCATION + userFolder;
...
//# sourceMappingURL=muttler.config.js.map